...
export class WasmTuner {
     ...
     * @param {number} tau_thres
     * @param {number} min_freq
     */
    constructor(sampling_rate, tau_thres, min_freq) {
        const ret = wasm.wasmtuner_new(sampling_rate, tau_thres, min_freq);
    ...
    process_audio(buffer) {
        ...
        const ret = wasm.wasmtuner_process_audio(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tuner_dsp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
